...
<link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php echo url('/assets/images/apple-touch-icon-57x57.png'); ?>"> <?php // iPhone, iOS ≤ 6, @1x + Android 2.1+ devices ?>
<link rel="apple-touch-icon-precomposed" sizes="60x60" href="<?php echo url('/assets/images/apple-touch-icon-60x60.png'); ?>"> <?php // iPhone, iOS ≥ 7, @1x ?>
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo url('/assets/images/apple-touch-icon-72x72.png'); ?>"> <?php //  iPad, iOS ≤ 6, @1x ?>
<link rel="apple-touch-icon-precomposed" sizes="76x76" href="<?php echo url('/assets/images/apple-touch-icon-76x76.png'); ?>"> <?php //  iPad, iOS ≥ 7, @1x ?>
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo url('/assets/images/apple-touch-icon-114x114.png'); ?>"> <?php // iPhone, iOS ≤ 6, @2x ?>
<link rel="apple-touch-icon-precomposed" sizes="120x120" href="<?php echo url('/assets/images/apple-touch-icon-120x120.png'); ?>"> <?php // iPhone, iOS ≥ 7, @2x and @3x ?>
