<?php ///////////////////////////////////////////////////////
// ----------------------------------------------------------
// Basic template for a table output of the calendar's data
// ----------------------------------------------------------
	...
	<tbody>
		<?php foreach($this->events as $event): ?>
			<?php
				...
				$monthIsPast = ($begin[0] < $currentTime[0] && $begin['month'] != $currentTime['month']) ? true : false;
			?>
			<?php if($month != $tempMonth): $month = $tempMonth; ?>
				<tr class="month<?php echo ($monthIsPast) ? ' past' : ''; ?>">
					<td colspan="<?php echo count($columnsArr) + 1; ?>"><?php echo utf8_encode($month); ?></td>
				</tr>
			<?php endif; ?>
			<tr<?php if(($end && $end[0] < time()) || !$end && $begin[0] < time()): echo ' class="past"'; endif; ?>>
				<td>
