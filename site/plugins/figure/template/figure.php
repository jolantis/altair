 <figure class="FigureImage">
	...
	<?php if($lazyload == true && c::get('resrc') == true): ?>
		<div class="FigureImage-lazy lazyload" style="padding-bottom: <?php echo $percentage_padding; ?>%;">
			<img data-sizes="auto" data-src="<?php echo 'http://' . c::get('resrc.plan') . '/s=w{width}/o={quality}/' . $thumburl; ?>" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" class="FigureImage-item <?php if($class): echo $class . ' '; endif; ?>js-resrcIsLazy" alt="<?php if($alt): echo $alt; endif; ?>" />
		</div>
	<?php endif; ?>
